//! `transport = "cli"` (Default, Legacy-Pfad): ruft `openclaw.binary` als
//! Subprozess je Runde auf, liest die Antwort aus dessen `--json`-Ausgabe.
...
use super::{render_message, reset_due, CHANNEL_PLACEHOLDER, MESSAGE_PLACEHOLDER};
